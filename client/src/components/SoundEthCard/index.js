...
function SoundEthCard(){
    return(
        <div class="meat">
            <div>
                <p class="soundcaption">This work is in the tradition of sound ethnography — anthropological approaches to soundscapes aiming to explore how humans express and understand culture through sound.</p>
                <div class="bcBtnDiv">
