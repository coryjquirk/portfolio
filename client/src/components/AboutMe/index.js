    ...
    return(
        <div>
          ...
          <div class="meat">
            ...
            <br/>
            <p>I'm a full-stack web developer looking for full time remote work and small project work. I built this website to display my web development projects, film photography, and sound work. On the <a href="/contact">contact page</a> you can find my LinkedIn profile, resume, and my GitHub page to see projects I've coded.
              </p>
              <p id="break">-. --- .--</p>
