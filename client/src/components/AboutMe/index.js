...
function AboutMe(props){
    return(
        <div id = "bio">
          ...
          <br/>
          <p>I'm a full-stack web developer and a student University of Minnesota coding bootcamp student. 
            Looking for full time work in information technology or web development. On this site you can find some of my web dev work, film photography, and sound art work.
            </p>
            <p id="break">-. --- .--</p>
            <p>I reside in Minneapolis, MN and my ultimate goal is to work in Norway. I've studyied Norwegian since 2018
             and I also have professional experience using Spanish. My academic background is in sociocultural anthropology, with a focus on the ethnography of sound. During undergrad I took my audio engineering knowledge from music to make sensory ethnography work, or documentaries of human culture focused on the senses. My final project was to record the soundscape of Hidden Falls
