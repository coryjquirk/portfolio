    ...
    <div id="blogPost">
      ...
      {opened === true && (
        <div>
          ...
          <p>
            The <a href="https://www.raspberrypi.org/products/raspberry-pi-pico/" target="_blank">Raspberry Pi RP2040</a> (Pico) costs just $4 per board as a new 2021
            addition to their line of products. From this microcontroller, you
            can build circuits to sense outside stimuli or control other parts
            in the device you're building. Microcontrollers play an important
            hidden role in modern technology for their ability to store small
            amounts of code for dedicated functions in consumer electronics.
            They consume little power and give their device a low-cost "brain,"
            but they process slowly and do not use memory as contrasted with a
            full-fledged PC that contains a microprocessor (your AMD or Intel
            CPU).
          </p>
          <p>
            This sounded like a great opportunity for my first computer soldering project. In order to get electricity flowing in and out of the
            microcontroller from the breadboard it's sitting on, I needed to
          ...
          <p>
            ...
            transverse myelitis that makes it difficult to keep steady hands
            when using fine motor skills. I had to be extra careful to stabilize
            both of my hands and it took a couple of small soldering iron burns
            to find the right position. I'm also not the target demographic for
            this product and someone with smaller hands would have an easier
            time. When I told my dad about this project, he mentioned that his
            mother spent some years performing soldering work at an electronics
          ...
          <p>
            ...
            MicroPython is a Python interpreter written in specifically for
            microcontrollers like the Pico.{" "}
          </p>
          <ModalImage
            small={button}
            large={button}
          ...
          <p>
            ...
            strrike when I gave electricity to my first soldering job, but so
            far so good. For $4 a board there's not a ton at risk. For a
            production scale product, you would of course want to buy many
            microcontrollers (one for each device you build), so in an
            industrial context I'm sure there are much cheaper boards with just
            the bare minimum amount of features.
          </p>
          <p>
            ...
            I'm working with CircuitPython, a derivative forked from
            MicroPython, for on a Nordic Semiconductor nRF52840 board from
            Sparkfun. I'll write about that more soon but so far I'm happy to
            have programmed simple tasks on the SparkFun board, like basic LED
            programming and initiating a basic bluetooth connection with my
            smartphone.
          </p>
          <ModalImage
            small={after}
