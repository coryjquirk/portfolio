...
function BandcampCard(props){
    return(
        <div class="meat" id="bandcampcard">
            ...
            <p class="soundcaption">Group improvisation is done as Watershed Group (rotating members)</p>
            <p class="soundcaption">We like to use samples and field recordings along with live instrumentation and analog electronics. Musically we take from noise, drone, ambient, and free jazz</p>
            ...
            <p class="soundcaption">Sound ethnography and field recording work is released under my own name</p>
