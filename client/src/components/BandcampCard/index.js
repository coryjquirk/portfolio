...
function BandcampCard(props){
    return(
        <div class="meat" id="bandcampcard">
            ...
            <p class="soundcaption">In group improvisation with Watershed Group, we like to use samples and field recordings along with live instrumentation and analog electronics. It is noisy</p>
